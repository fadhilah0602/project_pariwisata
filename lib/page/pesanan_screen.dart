...
class _PesananScreen extends State<PesananScreen> with WidgetsBindingObserver {
  ...
  Future<void> _fetchPesanan() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.109/pariwisata/listPesanan.php?id_user=${sessionManager.id_user}'));
  ...
  Future<void> deletePesanan(String idPesanan) async {
    final String apiUrl = 'http://192.168.1.109/pariwisata/deletePesanan.php';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ClipRRect(
                            ...
                            child: Image.network(
                              'http://192.168.1.109/pariwisata/${pesanan.gambar}', // URL gambar
                              height: 200,
