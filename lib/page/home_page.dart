...
class _PageMulaiState extends State<PageMulai> with TickerProviderStateMixin {
  ...
  Future<void> fetchPariwisata({String? idKategori}) async {
    try {
      ...
      String url = idKategori == null
          ? 'http://192.168.1.109/pariwisata/pariwisata.php'
          : 'http://192.168.1.109/pariwisata/pariwisata.php?id_kategori=$idKategori';
  ...
  //   try {
  //     http.Response res =
  //     await http.get(Uri.parse('http://192.168.1.109/pariwisata/pariwisata.php?id_kategori=$idKategori'));
  //     if (res.statusCode == 200) {
  //       var decodedResponse = modelPariwisataFromJson(res.body);
  //       if (decodedResponse.isSuccess && decodedResponse.data != null) {
  //         List<Pariwisata> allProducts = decodedResponse.data!;
  ...
  Future<void> fetchCategories() async {
    try {
      http.Response res =
      await http.get(Uri.parse('http://192.168.1.109/pariwisata/kategori.php'));
      setState(() {
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Image.network(
                                  ...
                                  'http://192.168.1.109/pariwisata/${pariwisata.gambar}',
                                  height: 150,
                                  width: double.infinity,
                                  fit: BoxFit.cover,
                                ),
